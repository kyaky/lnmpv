...
clear
echo "========================================================================="
echo "One key install Varnish Nginx PHP MySQL Memcached APC for Ubuntu 12.*"
echo "========================================================================="
echo "Made by Extreme"
echo "My Blog:http://yzs.me/"
echo "For more information please visit http://www.mke2fs.com"
echo "========================================================================="
echo "If your system is Ubuntu 12.*. Press any key to start install.Or press Ctrl+C to quit."
	char=`get_char`
installdir=$(pwd)
apt-get -y update
